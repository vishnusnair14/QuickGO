...
import com.vishnu.quickgovendor.databinding.FragmentResetPswdBinding;
...
//        preferences = requireActivity().getSharedPreferences("MyPrefs", Context.MODE_PRIVATE);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding = com.vishnu.quickgovendor.databinding.FragmentResetPswdBinding.inflate(inflater, container, false);
